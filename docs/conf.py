...
extensions = [
    ...
    "sphinx.ext.napoleon",
    "sphinxfortran.fortran_autodoc",                                            # pip-3.13 install --user git+https://github.com/VACUMM/sphinx-fortran.git@master
    "sphinxfortran.fortran_domain",                                             # pip-3.13 install --user git+https://github.com/VACUMM/sphinx-fortran.git@master
]
