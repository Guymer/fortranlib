MODULE mod_safe
    ...
    INCLUDE "mod_safe/sub_find_middle_of_locs_euclideanCircle.f90"
    INCLUDE "mod_safe/sub_find_middle_of_locs_geodesicBox.f90"
    INCLUDE "mod_safe/sub_find_middle_of_locs_geodesicCircle.f90"
    ...
    INCLUDE "mod_safe/sub_linearRegression.f90"
    ...
    INCLUDE "mod_safe/sub_quadraticRegression.f90"
