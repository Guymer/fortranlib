...
PURE FUNCTION func_integrate_2D_REAL128_real_array(n1, n2, x1, x2, arr) RESULT(ans)
    ...
    REAL(kind = REAL128), DIMENSION(n2), INTENT(in)                             :: x2
    REAL(kind = REAL128), DIMENSION(n1, n2), INTENT(in)                         :: arr
