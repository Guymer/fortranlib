...
!>
!> @param[in] n1 The size of the first variable of integration.
!>
!> @param[in] n2 The size of the second variable of integration.
!>
...
PURE FUNCTION func_integrate_2D_REAL32_real_array(n1, n2, x1, x2, arr) RESULT(ans)
    ...
    REAL(kind = REAL32), DIMENSION(n1), INTENT(in)                              :: x1
    REAL(kind = REAL32), DIMENSION(n2), INTENT(in)                              :: x2
    REAL(kind = REAL32), DIMENSION(n1, n2), INTENT(in)                          :: arr
    ...
    DO i1 = 1_INT64, n1 - 1_INT64
        ...
        DO i2 = 1_INT64, n2 - 1_INT64
            ...
            ans = ans + (x1(i1 + 1_INT64) - x1(i1)) * (x2(i2 + 1_INT64) - x2(i2)) * 0.25e0_REAL32 * (arr(i1, i2) + arr(i1 + 1_INT64, i2) + arr(i1, i2 + 1_INT64) + arr(i1 + 1_INT64, i2 + 1_INT64))
        END DO
    END DO
END FUNCTION func_integrate_2D_REAL32_real_array
