...
ELEMENTAL FUNCTION func_interpolate_REAL128_points(x1, x2, y1, y2, x) RESULT(ans)
    USE ISO_FORTRAN_ENV
    ...
    REAL(kind = REAL128), INTENT(in)                                            :: y1
    REAL(kind = REAL128), INTENT(in)                                            :: y2
...
END FUNCTION func_interpolate_REAL128_points
