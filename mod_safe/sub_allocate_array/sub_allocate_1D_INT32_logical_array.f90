!> @brief This subroutine allocates a 1D INT32 logical array.
!>
!> @param[inout] arr The 1D INT32 logical array to be allocated
!>
...
SUBROUTINE sub_allocate_1D_INT32_logical_array(arr, name, n1, debug)
    ...
    IF(errnum /= 0_INT32)THEN
        ...
        STOP
    END IF
END SUBROUTINE sub_allocate_1D_INT32_logical_array
