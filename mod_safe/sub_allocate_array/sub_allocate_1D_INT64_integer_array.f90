!> @brief This subroutine allocates a 1D INT64 integer array.
!>
!> @param[inout] arr The 1D INT64 integer array to be allocated
!>
...
SUBROUTINE sub_allocate_1D_INT64_integer_array(arr, name, n1, debug)
    USE ISO_FORTRAN_ENV
    ...
    IF(errnum /= 0_INT32)THEN
        ...
        STOP
    END IF
END SUBROUTINE sub_allocate_1D_INT64_integer_array
