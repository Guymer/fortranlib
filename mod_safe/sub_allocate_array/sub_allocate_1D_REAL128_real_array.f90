!> @brief This subroutine allocates a 1D REAL128 real array.
!>
!> @param[inout] arr The 1D REAL128 real array to be allocated
!>
...
SUBROUTINE sub_allocate_1D_REAL128_real_array(arr, name, n1, debug)
    ...
    IF(errnum /= 0_INT32)THEN
        ...
        STOP
    END IF
END SUBROUTINE sub_allocate_1D_REAL128_real_array
