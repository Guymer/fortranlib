!> @brief This subroutine allocates a 2D INT64 integer array.
!>
!> @param[inout] arr The 2D INT64 integer array to be allocated
!>
...
SUBROUTINE sub_allocate_2D_INT64_integer_array(arr, name, n1, n2, debug)
    USE ISO_FORTRAN_ENV
    ...
    IF(errnum /= 0_INT32)THEN
        ...
        STOP
    END IF
END SUBROUTINE sub_allocate_2D_INT64_integer_array
