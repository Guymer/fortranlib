!> @brief This subroutine allocates a 2D INT64 logical array.
!>
!> @param[inout] arr The 2D INT64 logical array to be allocated
!>
...
SUBROUTINE sub_allocate_2D_INT64_logical_array(arr, name, n1, n2, debug)
    ...
    IF(debug)THEN
        ! Calculate size ...
        tmp = REAL(n1 * n2 * STORAGE_SIZE(arr, kind = INT64) / 8_INT64, kind = REAL64) / 1024.0e0_REAL64
        units = "KiB"
