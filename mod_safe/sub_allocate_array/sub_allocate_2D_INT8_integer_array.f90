!> @brief This subroutine allocates a 2D INT8 integer array.
!>
!> @param[inout] arr The 2D INT8 integer array to be allocated
!>
...
SUBROUTINE sub_allocate_2D_INT8_integer_array(arr, name, n1, n2, debug)
    ...
    IF(errnum /= 0_INT32)THEN
        ...
        STOP
    END IF
END SUBROUTINE sub_allocate_2D_INT8_integer_array
