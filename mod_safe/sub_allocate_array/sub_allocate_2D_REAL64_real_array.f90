!> @brief This subroutine allocates a 2D REAL64 real array.
!>
!> @param[inout] arr The 2D REAL64 real array to be allocated
!>
...
SUBROUTINE sub_allocate_2D_REAL64_real_array(arr, name, n1, n2, debug)
    ...
    IF(errnum /= 0_INT32)THEN
        ...
        STOP
    END IF
END SUBROUTINE sub_allocate_2D_REAL64_real_array
