!> @brief This subroutine allocates a 3D INT16 logical array.
!>
!> @param[inout] arr The 3D INT16 logical array to be allocated
!>
...
SUBROUTINE sub_allocate_3D_INT16_logical_array(arr, name, n1, n2, n3, debug)
    ...
    IF(errnum /= 0_INT32)THEN
        ...
        STOP
    END IF
END SUBROUTINE sub_allocate_3D_INT16_logical_array
