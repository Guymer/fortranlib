!> @brief This subroutine allocates a 3D INT8 logical array.
!>
!> @param[inout] arr The 3D INT8 logical array to be allocated
!>
...
SUBROUTINE sub_allocate_3D_INT8_logical_array(arr, name, n1, n2, n3, debug)
    USE ISO_FORTRAN_ENV
    ...
    IF(errnum /= 0_INT32)THEN
        ...
        STOP
    END IF
END SUBROUTINE sub_allocate_3D_INT8_logical_array
