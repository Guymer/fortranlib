!> @brief This subroutine allocates a 3D REAL32 real array.
!>
!> @param[inout] arr The 3D REAL32 real array to be allocated
!>
...
SUBROUTINE sub_allocate_3D_REAL32_real_array(arr, name, n1, n2, n3, debug)
    ...
    IF(errnum /= 0_INT32)THEN
        ...
        STOP
    END IF
END SUBROUTINE sub_allocate_3D_REAL32_real_array
