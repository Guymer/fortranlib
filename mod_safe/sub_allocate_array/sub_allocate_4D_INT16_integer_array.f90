!> @brief This subroutine allocates a 4D INT16 integer array.
!>
!> @param[inout] arr The 4D INT16 integer array to be allocated
!>
...
SUBROUTINE sub_allocate_4D_INT16_integer_array(arr, name, n1, n2, n3, n4, debug)
    USE ISO_FORTRAN_ENV
    ...
    IF(errnum /= 0_INT32)THEN
        ...
        STOP
    END IF
END SUBROUTINE sub_allocate_4D_INT16_integer_array
