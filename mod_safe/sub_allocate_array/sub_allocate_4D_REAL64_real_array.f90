!> @brief This subroutine allocates a 4D REAL64 real array.
!>
!> @param[inout] arr The 4D REAL64 real array to be allocated
!>
...
SUBROUTINE sub_allocate_4D_REAL64_real_array(arr, name, n1, n2, n3, n4, debug)
    USE ISO_FORTRAN_ENV
    ...
    IF(errnum /= 0_INT32)THEN
        ...
        STOP
    END IF
END SUBROUTINE sub_allocate_4D_REAL64_real_array
