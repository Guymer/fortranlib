!> @brief This subroutine allocates a 5D INT16 logical array.
!>
!> @param[inout] arr The 5D INT16 logical array to be allocated
!>
...
SUBROUTINE sub_allocate_5D_INT16_logical_array(arr, name, n1, n2, n3, n4, n5, debug)
    USE ISO_FORTRAN_ENV
    ...
    IF(errnum /= 0_INT32)THEN
        ...
        STOP
    END IF
END SUBROUTINE sub_allocate_5D_INT16_logical_array
