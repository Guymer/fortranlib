!> @brief This subroutine allocates a 7D INT16 integer array.
!>
!> @param[inout] arr The 7D INT16 integer array to be allocated
!>
...
SUBROUTINE sub_allocate_7D_INT16_integer_array(arr, name, n1, n2, n3, n4, n5, n6, n7, debug)
    ...
    INTEGER(kind = INT16), ALLOCATABLE, DIMENSION(:, :, :, :, :, :, :), INTENT(inout):: arr
    ...
    IF(errnum /= 0_INT32)THEN
        ...
        STOP
    END IF
END SUBROUTINE sub_allocate_7D_INT16_integer_array
