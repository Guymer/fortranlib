!> @brief This subroutine allocates a 7D INT64 integer array.
!>
!> @param[inout] arr The 7D INT64 integer array to be allocated
!>
...
SUBROUTINE sub_allocate_7D_INT64_integer_array(arr, name, n1, n2, n3, n4, n5, n6, n7, debug)
    ...
    IF(errnum /= 0_INT32)THEN
        ...
        STOP
    END IF
END SUBROUTINE sub_allocate_7D_INT64_integer_array
