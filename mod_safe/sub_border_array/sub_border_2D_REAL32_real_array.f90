!> @brief This subroutine creates a copy of the input 2D REAL32 real array with a border.
!>
!> @param[in] arr The input 2D REAL32 real array
!>
!> @param[out] borderedArr The output 2D REAL32 real array
!>
...
SUBROUTINE sub_border_2D_REAL32_real_array(n1, n2, arr, borderedArr, name, debug)
    ...
    REAL(kind = REAL32), DIMENSION(1:n1, 1:n2), INTENT(in)                      :: arr
    REAL(kind = REAL32), ALLOCATABLE, DIMENSION(:, :), INTENT(out)              :: borderedArr
    ...
    ! Fill array ...
    borderedArr = 0.0e0_REAL32
    DO i1 = 1_INT64, n1
        DO i2 = 1_INT64, n2
            borderedArr(i1, i2) = arr(i1, i2)
        END DO
    END DO
END SUBROUTINE sub_border_2D_REAL32_real_array
