PURE SUBROUTINE sub_flood_INT32_integer_array_iter(nx, ny, elev, seaLevel, flooded, ixlo, ixhi, iylo, iyhi)
    ...
    INTEGER(kind = INT32), DIMENSION(nx, ny), INTENT(in)                        :: elev
    INTEGER(kind = INT32), INTENT(in)                                           :: seaLevel
    ...
    DO iy = iyhi, iylo, -1_INT64
        ...
        END DO
    END DO
END SUBROUTINE sub_flood_INT32_integer_array_iter
