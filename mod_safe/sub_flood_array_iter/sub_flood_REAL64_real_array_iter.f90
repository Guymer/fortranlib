PURE SUBROUTINE sub_flood_REAL64_real_array_iter(nx, ny, elev, seaLevel, flooded, ixlo, ixhi, iylo, iyhi)
    ...
    REAL(kind = REAL64), DIMENSION(nx, ny), INTENT(in)                          :: elev
    REAL(kind = REAL64), INTENT(in)                                             :: seaLevel
    ...
    DO iy = iyhi, iylo, -1_INT64
        ...
        END DO
    END DO
END SUBROUTINE sub_flood_REAL64_real_array_iter
