!> @brief This subroutine loads a 1D INT64 logical array from a BIN file.
!>
!> @param[out] arr The 1D INT64 logical array to be loaded from a BIN file
!>
!> @param[in] fname The name of the BIN file
!>

SUBROUTINE sub_load_1D_INT64_logical_array_from_BIN(arr, fname)
    USE ISO_FORTRAN_ENV
    ...
    ! Close BIN ...
    CLOSE(unit = funit)
END SUBROUTINE sub_load_1D_INT64_logical_array_from_BIN
