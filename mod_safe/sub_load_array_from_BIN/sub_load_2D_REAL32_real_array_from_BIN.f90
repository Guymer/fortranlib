!> @brief This subroutine loads a 2D REAL32 real array from a BIN file.
!>
!> @param[out] arr The 2D REAL32 real array to be loaded from a BIN file
!>
!> @param[in] fname The name of the BIN file
!>

SUBROUTINE sub_load_2D_REAL32_real_array_from_BIN(arr, fname)
    USE ISO_FORTRAN_ENV
    ...
    ! Close BIN ...
    CLOSE(unit = funit)
END SUBROUTINE sub_load_2D_REAL32_real_array_from_BIN
