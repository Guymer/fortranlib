!> @brief This subroutine loads a 3D INT8 logical array from a BIN file.
!>
!> @param[out] arr The 3D INT8 logical array to be loaded from a BIN file
!>
...
SUBROUTINE sub_load_3D_INT8_logical_array_from_BIN(arr, fname)
    ...
    ! Close BIN ...
    CLOSE(unit = funit)
END SUBROUTINE sub_load_3D_INT8_logical_array_from_BIN
