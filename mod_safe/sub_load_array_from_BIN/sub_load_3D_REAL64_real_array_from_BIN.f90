!> @brief This subroutine loads a 3D REAL64 real array from a BIN file.
!>
!> @param[out] arr The 3D REAL64 real array to be loaded from a BIN file
!>
!> @param[in] fname The name of the BIN file
!>

SUBROUTINE sub_load_3D_REAL64_real_array_from_BIN(arr, fname)
    USE ISO_FORTRAN_ENV
    ...
    ! Close BIN ...
    CLOSE(unit = funit)
END SUBROUTINE sub_load_3D_REAL64_real_array_from_BIN
