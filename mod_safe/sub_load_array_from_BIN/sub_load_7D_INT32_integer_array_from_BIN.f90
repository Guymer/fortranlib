!> @brief This subroutine loads a 7D INT32 integer array from a BIN file.
!>
!> @param[out] arr The 7D INT32 integer array to be loaded from a BIN file
!>
!> @param[in] fname The name of the BIN file
!>

SUBROUTINE sub_load_7D_INT32_integer_array_from_BIN(arr, fname)
    USE ISO_FORTRAN_ENV
    ...
    ! Close BIN ...
    CLOSE(unit = funit)
END SUBROUTINE sub_load_7D_INT32_integer_array_from_BIN
