!> @brief This subroutine saves a 1D REAL128 real array to a BIN file.
!>
!> @param[in] arr The 1D REAL128 real array to be saved to a BIN file
!>
!> @param[in] fname The name of the BIN file
!>

SUBROUTINE sub_save_1D_REAL128_real_array_as_BIN(arr, fname)
    USE ISO_FORTRAN_ENV
    ...
    ! Close BIN ...
    CLOSE(unit = funit)
END SUBROUTINE sub_save_1D_REAL128_real_array_as_BIN
