!> @brief This subroutine saves a 2D REAL32 real array to a BIN file.
!>
!> @param[in] arr The 2D REAL32 real array to be saved to a BIN file
!>
...
SUBROUTINE sub_save_2D_REAL32_real_array_as_BIN(arr, fname)
    ...
    ! Close BIN ...
    CLOSE(unit = funit)
END SUBROUTINE sub_save_2D_REAL32_real_array_as_BIN
