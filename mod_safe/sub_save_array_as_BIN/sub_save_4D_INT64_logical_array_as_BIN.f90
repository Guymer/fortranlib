!> @brief This subroutine saves a 4D INT64 logical array to a BIN file.
!>
!> @param[in] arr The 4D INT64 logical array to be saved to a BIN file
!>
!> @param[in] fname The name of the BIN file
!>

SUBROUTINE sub_save_4D_INT64_logical_array_as_BIN(arr, fname)
    USE ISO_FORTRAN_ENV
    ...
    ! Close BIN ...
    CLOSE(unit = funit)
END SUBROUTINE sub_save_4D_INT64_logical_array_as_BIN
