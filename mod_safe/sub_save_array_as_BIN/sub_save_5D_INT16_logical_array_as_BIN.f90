!> @brief This subroutine saves a 5D INT16 logical array to a BIN file.
!>
!> @param[in] arr The 5D INT16 logical array to be saved to a BIN file
!>
!> @param[in] fname The name of the BIN file
!>

SUBROUTINE sub_save_5D_INT16_logical_array_as_BIN(arr, fname)
    USE ISO_FORTRAN_ENV
    ...
    ! Close BIN ...
    CLOSE(unit = funit)
END SUBROUTINE sub_save_5D_INT16_logical_array_as_BIN
