!> @brief This subroutine saves a 6D INT16 logical array to a BIN file.
!>
!> @param[in] arr The 6D INT16 logical array to be saved to a BIN file
!>
!> @param[in] fname The name of the BIN file
!>

SUBROUTINE sub_save_6D_INT16_logical_array_as_BIN(arr, fname)
    USE ISO_FORTRAN_ENV
    ...
    ! Close BIN ...
    CLOSE(unit = funit)
END SUBROUTINE sub_save_6D_INT16_logical_array_as_BIN
