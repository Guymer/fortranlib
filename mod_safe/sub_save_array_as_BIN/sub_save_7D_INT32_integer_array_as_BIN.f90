!> @brief This subroutine saves a 7D INT32 integer array to a BIN file.
!>
!> @param[in] arr The 7D INT32 integer array to be saved to a BIN file
!>
!> @param[in] fname The name of the BIN file
!>

SUBROUTINE sub_save_7D_INT32_integer_array_as_BIN(arr, fname)
    USE ISO_FORTRAN_ENV
    ...
    ! Close BIN ...
    CLOSE(unit = funit)
END SUBROUTINE sub_save_7D_INT32_integer_array_as_BIN
