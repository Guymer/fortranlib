!> @brief This subroutine saves a 2D INT16 logical array to a PBM file.
!>
!> @param[in] arr The 2D INT16 logical array to be saved to a PBM file
!>
...
SUBROUTINE sub_save_2D_INT16_logical_array_as_PBM(nx, ny, arr, fname)
    ...
    LOGICAL(kind = INT16), DIMENSION(nx, ny), INTENT(in)                        :: arr
    ...
    ! Clean up ...
    DEALLOCATE(img)
END SUBROUTINE sub_save_2D_INT16_logical_array_as_PBM
