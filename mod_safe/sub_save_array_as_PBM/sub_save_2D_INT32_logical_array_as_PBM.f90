!> @brief This subroutine saves a 2D INT32 logical array to a PBM file.
!>
!> @param[in] arr The 2D INT32 logical array to be saved to a PBM file
!>
...
SUBROUTINE sub_save_2D_INT32_logical_array_as_PBM(nx, ny, arr, fname)
    ...
    LOGICAL(kind = INT32), DIMENSION(nx, ny), INTENT(in)                        :: arr
    ...
    ! Clean up ...
    DEALLOCATE(img)
END SUBROUTINE sub_save_2D_INT32_logical_array_as_PBM
