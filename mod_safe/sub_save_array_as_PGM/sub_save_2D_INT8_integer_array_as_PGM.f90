!> @brief This subroutine saves a 2D INT8 integer array to a PGM file.
!>
!> @param[in] arr The 2D INT8 integer array to be saved to a PGM file
!>
...
SUBROUTINE sub_save_2D_INT8_integer_array_as_PGM(nx, ny, arr, fname)
    ...
    ! Clean up ...
    DEALLOCATE(img)
END SUBROUTINE sub_save_2D_INT8_integer_array_as_PGM
