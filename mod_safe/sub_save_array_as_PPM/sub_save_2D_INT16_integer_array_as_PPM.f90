!> @brief This subroutine saves a 2D INT16 integer array to a PPM file.
!>
!> @param[in] arr The 2D INT16 integer array to be saved to a PPM file
!>
...
SUBROUTINE sub_save_2D_INT16_integer_array_as_PPM(arr, fname, cm)
    USE ISO_FORTRAN_ENV
    ...
    ! Clean up ...
    DEALLOCATE(img)
END SUBROUTINE sub_save_2D_INT16_integer_array_as_PPM
