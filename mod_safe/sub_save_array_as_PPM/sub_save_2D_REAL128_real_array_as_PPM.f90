!> @brief This subroutine saves a 2D REAL128 real array to a PPM file.
!>
!> @param[in] arr The 2D REAL128 real array to be saved to a PPM file
!>
...
SUBROUTINE sub_save_2D_REAL128_real_array_as_PPM(arr, fname, cm)
    USE ISO_FORTRAN_ENV
    ...
    ! Clean up ...
    DEALLOCATE(img)
END SUBROUTINE sub_save_2D_REAL128_real_array_as_PPM
