!> @brief This subroutine saves a 2D REAL32 real array to a PPM file.
!>
!> @param[in] arr The 2D REAL32 real array to be saved to a PPM file
!>
...
SUBROUTINE sub_save_2D_REAL32_real_array_as_PPM(arr, fname, cm)
    ...
    DO ix = 1_INT64, nx
        ...
        DO iy = 1_INT64, ny
            ! Determine level ...
            lvl = MAX(0_INT64, MIN(255_INT64, NINT(255.0e0_REAL32 * arr(ix, iy), kind = INT64)))
    ...
    ! Clean up ...
    DEALLOCATE(img)
END SUBROUTINE sub_save_2D_REAL32_real_array_as_PPM
