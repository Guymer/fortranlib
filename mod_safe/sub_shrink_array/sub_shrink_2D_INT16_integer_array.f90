SUBROUTINE sub_shrink_2D_INT16_integer_array(nx, ny, arr, shrinkScale, shrunkenArr)
    ...
    INTEGER(kind = INT16), ALLOCATABLE, DIMENSION(:, :), INTENT(out)            :: shrunkenArr
    ...
    !$omp shared(shrunkenArr)
        ...
        !$omp end do
    !$omp end parallel
END SUBROUTINE sub_shrink_2D_INT16_integer_array
