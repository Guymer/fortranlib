SUBROUTINE sub_shrink_2D_INT32_integer_array(nx, ny, arr, shrinkScale, shrunkenArr)
    ...
    INTEGER(kind = INT32), ALLOCATABLE, DIMENSION(:, :), INTENT(out)            :: shrunkenArr
    ...
    !$omp shared(shrunkenArr)
        ...
        !$omp end do
    !$omp end parallel
END SUBROUTINE sub_shrink_2D_INT32_integer_array
