SUBROUTINE sub_shrink_2D_INT64_integer_array(nx, ny, arr, shrinkScale, shrunkenArr)
    ...
    INTEGER(kind = INT64), ALLOCATABLE, DIMENSION(:, :), INTENT(out)            :: shrunkenArr
    ...
    !$omp shared(shrunkenArr)
        ...
        !$omp end do
    !$omp end parallel
END SUBROUTINE sub_shrink_2D_INT64_integer_array
