SUBROUTINE sub_shrink_2D_INT8_integer_array_to_2D_REAL64_real_array(nx, ny, arr, shrinkScale, shrunkenArr)
    ...
    INTEGER(kind = INT8), DIMENSION(nx, ny), INTENT(in)                         :: arr
        ...
        !$omp schedule(dynamic)
            ...
            DO ix = 1_INT64, nx / shrinkScale
                ...
                DO iy = 1_INT64, ny / shrinkScale
                    ...
                    shrunkenArr(ix, iy) = REAL(SUM(INT(arr(ixlo:ixhi, iylo:iyhi), kind = INT64)), kind = REAL64) / REAL(shrinkScale * shrinkScale, kind = REAL64)
                END DO
            END DO
        !$omp end do
    !$omp end parallel
END SUBROUTINE sub_shrink_2D_INT8_integer_array_to_2D_REAL64_real_array
