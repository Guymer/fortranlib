SUBROUTINE sub_shrink_2D_INT8_logical_array_to_2D_REAL32_real_array(nx, ny, arr, shrinkScale, shrunkenArr)
        ...
        !$omp schedule(dynamic)
            ...
            DO ix = 1_INT64, nx / shrinkScale
                ...
                DO iy = 1_INT64, ny / shrinkScale
                    ...
                    shrunkenArr(ix, iy) = REAL(COUNT(arr(ixlo:ixhi, iylo:iyhi), kind = INT64), kind = REAL32) / REAL(shrinkScale * shrinkScale, kind = REAL32)
                END DO
            END DO
        !$omp end do
    !$omp end parallel
END SUBROUTINE sub_shrink_2D_INT8_logical_array_to_2D_REAL32_real_array
