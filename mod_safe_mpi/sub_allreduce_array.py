    ...
    for knd1, knd2 in zip(data[typ][0], data[typ][1]):
        ...
        for dim in xrange(7):
            ...
            src = (
                ...
                "!>\n"
                "!> @param[in] buff The {2:d}D {1:s} {0:s} array to be reduced\n"
                "!>\n"
                ...
                "\n"
                "        ! Reduce the parcel ...\n"
                "        CALL MPI_ALLREDUCE(MPI_IN_PLACE, buff_flat(i), parcel, {6:s}, op, comm, errnum)\n"
            ...
            # Save source ...
            open("sub_allreduce_array/sub_allreduce_{2:d}D_{1:s}_{0:s}_array.f90".format(typ, knd1, dim + 1), "wt").write(src)

# Open output file ...
with open("sub_allreduce_array.tmp", "wt") as fobj:
