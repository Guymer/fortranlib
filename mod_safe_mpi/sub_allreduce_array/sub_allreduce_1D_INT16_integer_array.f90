SUBROUTINE sub_allreduce_1D_INT16_integer_array(buff, op, comm)
    ! This subroutine reduces a 1D INT16 integer array.
    ...
    INTEGER(kind = INT16), CONTIGUOUS, DIMENSION(:), INTENT(inout), TARGET      :: buff ! The 1D INT16 integer array to be reduced.
