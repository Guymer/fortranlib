SUBROUTINE sub_allreduce_1D_INT32_integer_array(buff, op, comm)
    ! This subroutine reduces a 1D INT32 integer array.
    ...
    INTEGER(kind = INT32), CONTIGUOUS, DIMENSION(:), INTENT(inout), TARGET      :: buff ! The 1D INT32 integer array to be reduced.
