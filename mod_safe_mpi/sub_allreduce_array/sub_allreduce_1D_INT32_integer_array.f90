!> @brief This subroutine reduces a 1D INT32 integer array.
!>
!> @param[in] buff The 1D INT32 integer array to be reduced
!>
...
SUBROUTINE sub_allreduce_1D_INT32_integer_array(buff, op, comm)
    USE ISO_C_BINDING
    USE ISO_FORTRAN_ENV
    USE MPI
    ...
    ! Destroy pointer ...
    NULLIFY(buff_flat)
END SUBROUTINE sub_allreduce_1D_INT32_integer_array
