SUBROUTINE sub_allreduce_1D_INT8_integer_array(buff, op, comm)
    ! This subroutine reduces a 1D INT8 integer array.
    ...
    INTEGER(kind = INT8), CONTIGUOUS, DIMENSION(:), INTENT(inout), TARGET       :: buff ! The 1D INT8 integer array to be reduced.
    ...
    ! Destroy pointer ...
    NULLIFY(buff_flat)
END SUBROUTINE sub_allreduce_1D_INT8_integer_array
