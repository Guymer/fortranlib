SUBROUTINE sub_allreduce_1D_INT8_logical_array(buff, op, comm)
    ! This subroutine reduces a 1D INT8 logical array.
    ...
    LOGICAL(kind = INT8), CONTIGUOUS, DIMENSION(:), INTENT(inout), TARGET       :: buff ! The 1D INT8 logical array to be reduced.
