!> @brief This subroutine reduces a 1D REAL64 real array.
!>
!> @param[in] buff The 1D REAL64 real array to be reduced
!>
...
SUBROUTINE sub_allreduce_1D_REAL64_real_array(buff, op, comm)
    ...
    ! Destroy pointer ...
    NULLIFY(buff_flat)
END SUBROUTINE sub_allreduce_1D_REAL64_real_array
