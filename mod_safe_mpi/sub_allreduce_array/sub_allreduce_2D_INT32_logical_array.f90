!> @brief This subroutine reduces a 2D INT32 logical array.
!>
!> @param[in] buff The 2D INT32 logical array to be reduced
!>
...
SUBROUTINE sub_allreduce_2D_INT32_logical_array(buff, op, comm)
    USE ISO_C_BINDING
    USE ISO_FORTRAN_ENV
    USE MPI
    ...
    ! Destroy pointer ...
    NULLIFY(buff_flat)
END SUBROUTINE sub_allreduce_2D_INT32_logical_array
