SUBROUTINE sub_allreduce_2D_INT32_logical_array(buff, op, comm)
    ! This subroutine reduces a 2D INT32 logical array.
    ...
    LOGICAL(kind = INT32), CONTIGUOUS, DIMENSION(:, :), INTENT(inout), TARGET   :: buff ! The 2D INT32 logical array to be reduced.
