SUBROUTINE sub_allreduce_2D_INT8_integer_array(buff, op, comm)
    ! This subroutine reduces a 2D INT8 integer array.
    ...
    INTEGER(kind = INT8), CONTIGUOUS, DIMENSION(:, :), INTENT(inout), TARGET    :: buff ! The 2D INT8 integer array to be reduced.
