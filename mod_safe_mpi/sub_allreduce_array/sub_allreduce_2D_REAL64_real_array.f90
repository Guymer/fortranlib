SUBROUTINE sub_allreduce_2D_REAL64_real_array(buff, op, comm)
    ! This subroutine reduces a 2D REAL64 real array.
    ...
    REAL(kind = REAL64), CONTIGUOUS, DIMENSION(:, :), INTENT(inout), TARGET     :: buff ! The 2D REAL64 real array to be reduced.
    ...
    ! Destroy pointer ...
    NULLIFY(buff_flat)
END SUBROUTINE sub_allreduce_2D_REAL64_real_array
