SUBROUTINE sub_allreduce_3D_INT16_logical_array(buff, op, comm)
    ! This subroutine reduces a 3D INT16 logical array.
    ...
    LOGICAL(kind = INT16), CONTIGUOUS, DIMENSION(:, :, :), INTENT(inout), TARGET:: buff ! The 3D INT16 logical array to be reduced.
