SUBROUTINE sub_allreduce_3D_INT32_logical_array(buff, op, comm)
    ! This subroutine reduces a 3D INT32 logical array.
    ...
    LOGICAL(kind = INT32), CONTIGUOUS, DIMENSION(:, :, :), INTENT(inout), TARGET:: buff ! The 3D INT32 logical array to be reduced.
