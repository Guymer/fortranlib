SUBROUTINE sub_allreduce_3D_INT64_logical_array(buff, op, comm)
    ! This subroutine reduces a 3D INT64 logical array.
    ...
    LOGICAL(kind = INT64), CONTIGUOUS, DIMENSION(:, :, :), INTENT(inout), TARGET:: buff ! The 3D INT64 logical array to be reduced.
    ...
    ! Destroy pointer ...
    NULLIFY(buff_flat)
END SUBROUTINE sub_allreduce_3D_INT64_logical_array
