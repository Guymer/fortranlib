SUBROUTINE sub_allreduce_4D_INT16_logical_array(buff, op, comm)
    ! This subroutine reduces a 4D INT16 logical array.
    ...
    LOGICAL(kind = INT16), CONTIGUOUS, DIMENSION(:, :, :, :), INTENT(inout), TARGET:: buff ! The 4D INT16 logical array to be reduced.
