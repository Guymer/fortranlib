SUBROUTINE sub_allreduce_4D_INT32_integer_array(buff, op, comm)
    ! This subroutine reduces a 4D INT32 integer array.
    ...
    INTEGER(kind = INT32), CONTIGUOUS, DIMENSION(:, :, :, :), INTENT(inout), TARGET:: buff ! The 4D INT32 integer array to be reduced.
