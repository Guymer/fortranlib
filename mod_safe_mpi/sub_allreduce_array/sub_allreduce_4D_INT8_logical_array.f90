SUBROUTINE sub_allreduce_4D_INT8_logical_array(buff, op, comm)
    ! This subroutine reduces a 4D INT8 logical array.
    ...
    LOGICAL(kind = INT8), CONTIGUOUS, DIMENSION(:, :, :, :), INTENT(inout), TARGET:: buff ! The 4D INT8 logical array to be reduced.
    ...
    ! Destroy pointer ...
    NULLIFY(buff_flat)
END SUBROUTINE sub_allreduce_4D_INT8_logical_array
