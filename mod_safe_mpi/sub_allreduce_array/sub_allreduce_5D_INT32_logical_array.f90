!> @brief This subroutine reduces a 5D INT32 logical array.
!>
!> @param[in] buff The 5D INT32 logical array to be reduced
!>
...
SUBROUTINE sub_allreduce_5D_INT32_logical_array(buff, op, comm)
    ...
    ! Destroy pointer ...
    NULLIFY(buff_flat)
END SUBROUTINE sub_allreduce_5D_INT32_logical_array
