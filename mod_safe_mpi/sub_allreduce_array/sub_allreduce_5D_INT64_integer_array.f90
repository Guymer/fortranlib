SUBROUTINE sub_allreduce_5D_INT64_integer_array(buff, op, comm)
    ! This subroutine reduces a 5D INT64 integer array.
    ...
    INTEGER(kind = INT64), CONTIGUOUS, DIMENSION(:, :, :, :, :), INTENT(inout), TARGET:: buff ! The 5D INT64 integer array to be reduced.
