!> @brief This subroutine reduces a 5D INT64 integer array.
!>
!> @param[in] buff The 5D INT64 integer array to be reduced
!>
...
SUBROUTINE sub_allreduce_5D_INT64_integer_array(buff, op, comm)
    USE ISO_C_BINDING
    USE ISO_FORTRAN_ENV
    USE MPI
    ...
    ! Destroy pointer ...
    NULLIFY(buff_flat)
END SUBROUTINE sub_allreduce_5D_INT64_integer_array
