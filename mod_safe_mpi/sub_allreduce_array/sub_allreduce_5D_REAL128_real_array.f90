SUBROUTINE sub_allreduce_5D_REAL128_real_array(buff, op, comm)
    ! This subroutine reduces a 5D REAL128 real array.
    ...
    REAL(kind = REAL128), CONTIGUOUS, DIMENSION(:, :, :, :, :), INTENT(inout), TARGET:: buff ! The 5D REAL128 real array to be reduced.
    ...
    ! Destroy pointer ...
    NULLIFY(buff_flat)
END SUBROUTINE sub_allreduce_5D_REAL128_real_array
