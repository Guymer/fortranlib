SUBROUTINE sub_allreduce_5D_REAL32_real_array(buff, op, comm)
    ! This subroutine reduces a 5D REAL32 real array.
    ...
    REAL(kind = REAL32), CONTIGUOUS, DIMENSION(:, :, :, :, :), INTENT(inout), TARGET:: buff ! The 5D REAL32 real array to be reduced.
    ...
    ! Destroy pointer ...
    NULLIFY(buff_flat)
END SUBROUTINE sub_allreduce_5D_REAL32_real_array
