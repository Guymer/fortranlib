SUBROUTINE sub_allreduce_6D_INT16_logical_array(buff, op, comm)
    ! This subroutine reduces a 6D INT16 logical array.
    ...
    LOGICAL(kind = INT16), CONTIGUOUS, DIMENSION(:, :, :, :, :, :), INTENT(inout), TARGET:: buff ! The 6D INT16 logical array to be reduced.
