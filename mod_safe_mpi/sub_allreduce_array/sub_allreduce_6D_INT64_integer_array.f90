SUBROUTINE sub_allreduce_6D_INT64_integer_array(buff, op, comm)
    ! This subroutine reduces a 6D INT64 integer array.
    ...
    INTEGER(kind = INT64), CONTIGUOUS, DIMENSION(:, :, :, :, :, :), INTENT(inout), TARGET:: buff ! The 6D INT64 integer array to be reduced.
