SUBROUTINE sub_allreduce_6D_INT64_logical_array(buff, op, comm)
    ! This subroutine reduces a 6D INT64 logical array.
    ...
    LOGICAL(kind = INT64), CONTIGUOUS, DIMENSION(:, :, :, :, :, :), INTENT(inout), TARGET:: buff ! The 6D INT64 logical array to be reduced.
