SUBROUTINE sub_allreduce_6D_INT8_integer_array(buff, op, comm)
    ! This subroutine reduces a 6D INT8 integer array.
    ...
    INTEGER(kind = INT8), CONTIGUOUS, DIMENSION(:, :, :, :, :, :), INTENT(inout), TARGET:: buff ! The 6D INT8 integer array to be reduced.
    ...
    ! Destroy pointer ...
    NULLIFY(buff_flat)
END SUBROUTINE sub_allreduce_6D_INT8_integer_array
