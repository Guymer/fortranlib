!> @brief This subroutine reduces a 7D INT16 integer array.
!>
!> @param[in] buff The 7D INT16 integer array to be reduced
!>
...
SUBROUTINE sub_allreduce_7D_INT16_integer_array(buff, op, comm)
    USE ISO_C_BINDING
    USE ISO_FORTRAN_ENV
    USE MPI
    ...
    INTEGER(kind = INT16), DIMENSION(:, :, :, :, :, :, :), INTENT(inout), TARGET:: buff
    ...
    INTEGER(kind = INT16), DIMENSION(:), POINTER                                :: buff_flat
    ...
    ! Destroy pointer ...
    NULLIFY(buff_flat)
END SUBROUTINE sub_allreduce_7D_INT16_integer_array
