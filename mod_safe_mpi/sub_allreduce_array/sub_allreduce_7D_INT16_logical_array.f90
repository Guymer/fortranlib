!> @brief This subroutine reduces a 7D INT16 logical array.
!>
!> @param[in] buff The 7D INT16 logical array to be reduced
!>
...
SUBROUTINE sub_allreduce_7D_INT16_logical_array(buff, op, comm)
    USE ISO_C_BINDING
    USE ISO_FORTRAN_ENV
    USE MPI
    ...
    LOGICAL(kind = INT16), CONTIGUOUS, DIMENSION(:, :, :, :, :, :, :), INTENT(inout), TARGET:: buff
    ...
    LOGICAL(kind = INT16), CONTIGUOUS, DIMENSION(:), POINTER                    :: buff_flat
    ...
    DO i = 1_INT64, n, chunk
        ...
        ! Reduce the parcel ...
        CALL MPI_ALLREDUCE(MPI_IN_PLACE, buff_flat(i), parcel, MPI_INTEGER2, op, comm, errnum)
    ...
    ! Destroy pointer ...
    NULLIFY(buff_flat)
END SUBROUTINE sub_allreduce_7D_INT16_logical_array
