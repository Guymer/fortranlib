SUBROUTINE sub_allreduce_7D_INT32_logical_array(buff, op, comm)
    ! This subroutine reduces a 7D INT32 logical array.
    ...
    LOGICAL(kind = INT32), CONTIGUOUS, DIMENSION(:, :, :, :, :, :, :), INTENT(inout), TARGET:: buff ! The 7D INT32 logical array to be reduced.
