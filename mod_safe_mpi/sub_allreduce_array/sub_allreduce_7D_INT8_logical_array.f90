!> @brief This subroutine reduces a 7D INT8 logical array.
!>
!> @param[in] buff The 7D INT8 logical array to be reduced
!>
...
SUBROUTINE sub_allreduce_7D_INT8_logical_array(buff, op, comm)
    ...
    ! Destroy pointer ...
    NULLIFY(buff_flat)
END SUBROUTINE sub_allreduce_7D_INT8_logical_array
