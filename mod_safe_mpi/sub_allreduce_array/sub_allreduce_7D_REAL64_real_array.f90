SUBROUTINE sub_allreduce_7D_REAL64_real_array(buff, op, comm)
    ! This subroutine reduces a 7D REAL64 real array.
    ...
    REAL(kind = REAL64), CONTIGUOUS, DIMENSION(:, :, :, :, :, :, :), INTENT(inout), TARGET:: buff ! The 7D REAL64 real array to be reduced.
    ...
    DO i = 1_INT64, n, chunk
        ...
        ! Reduce the parcel ...
        CALL MPI_ALLREDUCE(MPI_IN_PLACE, buff_flat(i), parcel, MPI_REAL8, op, comm, errnum)
    ...
    ! Destroy pointer ...
    NULLIFY(buff_flat)
END SUBROUTINE sub_allreduce_7D_REAL64_real_array
