SUBROUTINE sub_bcast_1D_INT16_logical_array(buff, root, comm)
    ! This subroutine broadcasts a 1D INT16 logical array.
    ...
    LOGICAL(kind = INT16), CONTIGUOUS, DIMENSION(:), INTENT(inout), TARGET      :: buff ! The 1D INT16 logical array to be broadcast.
