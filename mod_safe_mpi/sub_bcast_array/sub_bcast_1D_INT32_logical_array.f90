!> @brief This subroutine broadcasts a 1D INT32 logical array.
!>
!> @param[in] buff The 1D INT32 logical array to be broadcast
!>
...
SUBROUTINE sub_bcast_1D_INT32_logical_array(buff, root, comm)
    USE ISO_C_BINDING
    USE ISO_FORTRAN_ENV
    USE MPI
    ...
    ! Destroy pointer ...
    NULLIFY(buff_flat)
END SUBROUTINE sub_bcast_1D_INT32_logical_array
