SUBROUTINE sub_bcast_1D_INT64_integer_array(buff, root, comm)
    ! This subroutine broadcasts a 1D INT64 integer array.
    ...
    INTEGER(kind = INT64), CONTIGUOUS, DIMENSION(:), INTENT(inout), TARGET      :: buff ! The 1D INT64 integer array to be broadcast.
