SUBROUTINE sub_bcast_1D_INT64_logical_array(buff, root, comm)
    ! This subroutine broadcasts a 1D INT64 logical array.
    ...
    LOGICAL(kind = INT64), CONTIGUOUS, DIMENSION(:), INTENT(inout), TARGET      :: buff ! The 1D INT64 logical array to be broadcast.
