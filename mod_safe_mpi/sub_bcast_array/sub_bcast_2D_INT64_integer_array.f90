SUBROUTINE sub_bcast_2D_INT64_integer_array(buff, root, comm)
    ! This subroutine broadcasts a 2D INT64 integer array.
    ...
    INTEGER(kind = INT64), CONTIGUOUS, DIMENSION(:, :), INTENT(inout), TARGET   :: buff ! The 2D INT64 integer array to be broadcast.
