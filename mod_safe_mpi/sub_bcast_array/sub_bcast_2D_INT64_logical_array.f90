SUBROUTINE sub_bcast_2D_INT64_logical_array(buff, root, comm)
    ! This subroutine broadcasts a 2D INT64 logical array.
    ...
    LOGICAL(kind = INT64), CONTIGUOUS, DIMENSION(:, :), INTENT(inout), TARGET   :: buff ! The 2D INT64 logical array to be broadcast.
