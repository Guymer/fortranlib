SUBROUTINE sub_bcast_2D_REAL32_real_array(buff, root, comm)
    ! This subroutine broadcasts a 2D REAL32 real array.
    ...
    REAL(kind = REAL32), CONTIGUOUS, DIMENSION(:, :), INTENT(inout), TARGET     :: buff ! The 2D REAL32 real array to be broadcast.
    ...
    ! Destroy pointer ...
    NULLIFY(buff_flat)
END SUBROUTINE sub_bcast_2D_REAL32_real_array
