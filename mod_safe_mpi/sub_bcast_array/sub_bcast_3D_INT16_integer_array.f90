SUBROUTINE sub_bcast_3D_INT16_integer_array(buff, root, comm)
    ! This subroutine broadcasts a 3D INT16 integer array.
    ...
    INTEGER(kind = INT16), CONTIGUOUS, DIMENSION(:, :, :), INTENT(inout), TARGET:: buff ! The 3D INT16 integer array to be broadcast.
