!> @brief This subroutine broadcasts a 3D INT32 logical array.
!>
!> @param[in] buff The 3D INT32 logical array to be broadcast
!>
...
SUBROUTINE sub_bcast_3D_INT32_logical_array(buff, root, comm)
    ...
    ! Destroy pointer ...
    NULLIFY(buff_flat)
END SUBROUTINE sub_bcast_3D_INT32_logical_array
