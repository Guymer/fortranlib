SUBROUTINE sub_bcast_3D_REAL128_real_array(buff, root, comm)
    ! This subroutine broadcasts a 3D REAL128 real array.
    ...
    REAL(kind = REAL128), CONTIGUOUS, DIMENSION(:, :, :), INTENT(inout), TARGET :: buff ! The 3D REAL128 real array to be broadcast.
    ...
    ! Destroy pointer ...
    NULLIFY(buff_flat)
END SUBROUTINE sub_bcast_3D_REAL128_real_array
