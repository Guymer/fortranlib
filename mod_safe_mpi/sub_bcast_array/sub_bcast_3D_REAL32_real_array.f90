!> @brief This subroutine broadcasts a 3D REAL32 real array.
!>
!> @param[in] buff The 3D REAL32 real array to be broadcast
!>
...
SUBROUTINE sub_bcast_3D_REAL32_real_array(buff, root, comm)
    ...
    ! Destroy pointer ...
    NULLIFY(buff_flat)
END SUBROUTINE sub_bcast_3D_REAL32_real_array
