!> @brief This subroutine broadcasts a 3D REAL64 real array.
!>
!> @param[in] buff The 3D REAL64 real array to be broadcast
!>
...
SUBROUTINE sub_bcast_3D_REAL64_real_array(buff, root, comm)
    USE ISO_C_BINDING
    USE ISO_FORTRAN_ENV
    USE MPI
    ...
    ! Destroy pointer ...
    NULLIFY(buff_flat)
END SUBROUTINE sub_bcast_3D_REAL64_real_array
