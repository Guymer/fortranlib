SUBROUTINE sub_bcast_4D_INT16_integer_array(buff, root, comm)
    ! This subroutine broadcasts a 4D INT16 integer array.
    ...
    INTEGER(kind = INT16), CONTIGUOUS, DIMENSION(:, :, :, :), INTENT(inout), TARGET:: buff ! The 4D INT16 integer array to be broadcast.
