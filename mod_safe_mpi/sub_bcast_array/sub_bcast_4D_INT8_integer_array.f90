SUBROUTINE sub_bcast_4D_INT8_integer_array(buff, root, comm)
    ! This subroutine broadcasts a 4D INT8 integer array.
    ...
    INTEGER(kind = INT8), CONTIGUOUS, DIMENSION(:, :, :, :), INTENT(inout), TARGET:: buff ! The 4D INT8 integer array to be broadcast.
