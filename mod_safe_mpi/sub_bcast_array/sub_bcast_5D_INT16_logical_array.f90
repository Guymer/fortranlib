SUBROUTINE sub_bcast_5D_INT16_logical_array(buff, root, comm)
    ! This subroutine broadcasts a 5D INT16 logical array.
    ...
    LOGICAL(kind = INT16), CONTIGUOUS, DIMENSION(:, :, :, :, :), INTENT(inout), TARGET:: buff ! The 5D INT16 logical array to be broadcast.
