SUBROUTINE sub_bcast_5D_INT32_integer_array(buff, root, comm)
    ! This subroutine broadcasts a 5D INT32 integer array.
    ...
    INTEGER(kind = INT32), CONTIGUOUS, DIMENSION(:, :, :, :, :), INTENT(inout), TARGET:: buff ! The 5D INT32 integer array to be broadcast.
