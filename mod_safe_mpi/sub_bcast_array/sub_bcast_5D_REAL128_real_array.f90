SUBROUTINE sub_bcast_5D_REAL128_real_array(buff, root, comm)
    ! This subroutine broadcasts a 5D REAL128 real array.
    ...
    REAL(kind = REAL128), CONTIGUOUS, DIMENSION(:, :, :, :, :), INTENT(inout), TARGET:: buff ! The 5D REAL128 real array to be broadcast.
