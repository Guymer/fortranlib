!> @brief This subroutine broadcasts a 6D INT16 logical array.
!>
!> @param[in] buff The 6D INT16 logical array to be broadcast
!>
...
SUBROUTINE sub_bcast_6D_INT16_logical_array(buff, root, comm)
    USE ISO_C_BINDING
    USE ISO_FORTRAN_ENV
    USE MPI
    ...
    ! Destroy pointer ...
    NULLIFY(buff_flat)
END SUBROUTINE sub_bcast_6D_INT16_logical_array
