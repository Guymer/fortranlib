SUBROUTINE sub_bcast_6D_INT16_logical_array(buff, root, comm)
    ! This subroutine broadcasts a 6D INT16 logical array.
    ...
    LOGICAL(kind = INT16), CONTIGUOUS, DIMENSION(:, :, :, :, :, :), INTENT(inout), TARGET:: buff ! The 6D INT16 logical array to be broadcast.
