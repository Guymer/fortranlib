SUBROUTINE sub_bcast_6D_INT32_integer_array(buff, root, comm)
    ! This subroutine broadcasts a 6D INT32 integer array.
    ...
    INTEGER(kind = INT32), CONTIGUOUS, DIMENSION(:, :, :, :, :, :), INTENT(inout), TARGET:: buff ! The 6D INT32 integer array to be broadcast.
