!> @brief This subroutine broadcasts a 6D INT32 integer array.
!>
!> @param[in] buff The 6D INT32 integer array to be broadcast
!>
...
SUBROUTINE sub_bcast_6D_INT32_integer_array(buff, root, comm)
    USE ISO_C_BINDING
    USE ISO_FORTRAN_ENV
    USE MPI
    ...
    ! Destroy pointer ...
    NULLIFY(buff_flat)
END SUBROUTINE sub_bcast_6D_INT32_integer_array
