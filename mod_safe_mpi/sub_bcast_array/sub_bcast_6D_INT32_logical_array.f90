SUBROUTINE sub_bcast_6D_INT32_logical_array(buff, root, comm)
    ! This subroutine broadcasts a 6D INT32 logical array.
    ...
    LOGICAL(kind = INT32), CONTIGUOUS, DIMENSION(:, :, :, :, :, :), INTENT(inout), TARGET:: buff ! The 6D INT32 logical array to be broadcast.
