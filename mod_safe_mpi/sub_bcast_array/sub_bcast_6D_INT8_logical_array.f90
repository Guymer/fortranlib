SUBROUTINE sub_bcast_6D_INT8_logical_array(buff, root, comm)
    ! This subroutine broadcasts a 6D INT8 logical array.
    ...
    LOGICAL(kind = INT8), CONTIGUOUS, DIMENSION(:, :, :, :, :, :), INTENT(inout), TARGET:: buff ! The 6D INT8 logical array to be broadcast.
    ...
    ! Destroy pointer ...
    NULLIFY(buff_flat)
END SUBROUTINE sub_bcast_6D_INT8_logical_array
