SUBROUTINE sub_bcast_6D_REAL128_real_array(buff, root, comm)
    ! This subroutine broadcasts a 6D REAL128 real array.
    ...
    REAL(kind = REAL128), CONTIGUOUS, DIMENSION(:, :, :, :, :, :), INTENT(inout), TARGET:: buff ! The 6D REAL128 real array to be broadcast.
    ...
    ! Destroy pointer ...
    NULLIFY(buff_flat)
END SUBROUTINE sub_bcast_6D_REAL128_real_array
