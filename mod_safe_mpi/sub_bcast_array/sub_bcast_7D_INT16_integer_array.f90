!> @brief This subroutine broadcasts a 7D INT16 integer array.
!>
!> @param[in] buff The 7D INT16 integer array to be broadcast
!>
...
SUBROUTINE sub_bcast_7D_INT16_integer_array(buff, root, comm)
    USE ISO_C_BINDING
    USE ISO_FORTRAN_ENV
    USE MPI
    ...
    DO i = 1_INT64, n, chunk
        ...
        CALL MPI_BCAST(buff_flat(i), parcel, MPI_INTEGER2, root, comm, ierr)
    ...
    ! Destroy pointer ...
    NULLIFY(buff_flat)
END SUBROUTINE sub_bcast_7D_INT16_integer_array
