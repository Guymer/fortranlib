!> @brief This subroutine broadcasts a 7D INT32 integer array.
!>
!> @param[in] buff The 7D INT32 integer array to be broadcast
!>
...
SUBROUTINE sub_bcast_7D_INT32_integer_array(buff, root, comm)
    USE ISO_C_BINDING
    USE ISO_FORTRAN_ENV
    USE MPI
    ...
    INTEGER(kind = INT32), CONTIGUOUS, DIMENSION(:, :, :, :, :, :, :), INTENT(inout), TARGET:: buff
    ...
    INTEGER(kind = INT32), CONTIGUOUS, DIMENSION(:), POINTER                    :: buff_flat
    ...
    DO i = 1_INT64, n, chunk
        ...
        CALL MPI_BCAST(buff_flat(i), parcel, MPI_INTEGER4, root, comm, errnum)
    ...
    ! Destroy pointer ...
    NULLIFY(buff_flat)
END SUBROUTINE sub_bcast_7D_INT32_integer_array
