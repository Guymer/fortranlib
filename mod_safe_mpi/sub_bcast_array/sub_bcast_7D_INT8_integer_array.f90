SUBROUTINE sub_bcast_7D_INT8_integer_array(buff, root, comm)
    ! This subroutine broadcasts a 7D INT8 integer array.
    ...
    INTEGER(kind = INT8), CONTIGUOUS, DIMENSION(:, :, :, :, :, :, :), INTENT(inout), TARGET:: buff ! The 7D INT8 integer array to be broadcast.
    ...
    INTEGER(kind = INT64), PARAMETER                                            :: chunk = 8589934592_INT64 /   8_INT64

    ! Declare variables ...
    ! NOTE: "parcel" is the number of elements of "buff" that will be transfered
    !       in the current "MPI_BCAST" call.
    INTEGER(kind = INT8), CONTIGUOUS, DIMENSION(:), POINTER                     :: buff_flat
    ...
    CALL C_F_POINTER(C_LOC(buff(1_INT64, 1_INT64, 1_INT64, 1_INT64, 1_INT64, 1_INT64, 1_INT64)), buff_flat, (/ n /))
    ...
    DO i = 1_INT64, n, chunk
        ...
        CALL MPI_BCAST(buff_flat(i), parcel, MPI_INTEGER1, root, comm, errnum)
    ...
    ! Destroy pointer ...
    NULLIFY(buff_flat)
END SUBROUTINE sub_bcast_7D_INT8_integer_array
