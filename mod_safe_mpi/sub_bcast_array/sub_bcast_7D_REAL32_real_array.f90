SUBROUTINE sub_bcast_7D_REAL32_real_array(buff, root, comm)
    ! This subroutine broadcasts a 7D REAL32 real array.
    ...
    REAL(kind = REAL32), CONTIGUOUS, DIMENSION(:, :, :, :, :, :, :), INTENT(inout), TARGET:: buff ! The 7D REAL32 real array to be broadcast.
    ...
    DO i = 1_INT64, n, chunk
        ...
        CALL MPI_BCAST(buff_flat(i), parcel, MPI_REAL4, root, comm, errnum)
    ...
    ! Destroy pointer ...
    NULLIFY(buff_flat)
END SUBROUTINE sub_bcast_7D_REAL32_real_array
