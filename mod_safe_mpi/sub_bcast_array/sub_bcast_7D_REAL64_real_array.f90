!> @brief This subroutine broadcasts a 7D REAL64 real array.
!>
!> @param[in] buff The 7D REAL64 real array to be broadcast
!>
...
SUBROUTINE sub_bcast_7D_REAL64_real_array(buff, root, comm)
    USE ISO_C_BINDING
    USE ISO_FORTRAN_ENV
    USE MPI
    ...
    DO i = 1_INT64, n, chunk
        ...
        CALL MPI_BCAST(buff_flat(i), parcel, MPI_REAL8, root, comm, ierr)
    ...
    ! Destroy pointer ...
    NULLIFY(buff_flat)
END SUBROUTINE sub_bcast_7D_REAL64_real_array
