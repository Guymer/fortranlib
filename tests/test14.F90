PROGRAM test14
    ...
    ! NOTE: python3.13 -c "import pyguymer3; import pyguymer3.geo; print(pyguymer3.geo.calc_dist_between_two_locs(20.0, 40.0, 31.0, 44.0));"
    ...
    ! Solve and print summary ...
    ! NOTE: python3.13 -c "import pyguymer3; import pyguymer3.geo; print(pyguymer3.geo.calc_dist_between_two_locs(170.0, 10.0, -153.0, 14.0));"
    CALL sub_calc_dist_between_two_locs(lon1, lat1, lon2, lat2, dist, bear1, bear2)
    WRITE(fmt = '("How does Python compare to FORTRAN?")', unit = OUTPUT_UNIT)
    ...
    ! Solve and print summary ...
    ! NOTE: python3.13 -c "import pyguymer3; import pyguymer3.geo; print(pyguymer3.geo.calc_loc_from_loc_and_bearing_and_dist(20.0, 40.0, 60.0, 1000000.0));"
    ...
    ! Solve and print summary ...
    ! NOTE: python3.13 -c "import pyguymer3; import pyguymer3.geo; print(pyguymer3.geo.calc_loc_from_loc_and_bearing_and_dist(170.0, 10.0, 80.0, 4000000.0));"
    CALL sub_calc_loc_from_loc_and_bearing_and_dist(lon1, lat1, bear1, dist, lon2, lat2, bear2)
    WRITE(fmt = '("How does Python compare to FORTRAN?")', unit = OUTPUT_UNIT)
