PROGRAM main
    ...
    ! NOTE: python3.10 -c "import pyguymer3; print(pyguymer3.calc_loc_from_loc_and_bearing_and_dist(20.0, 40.0, 60.0, 1000000.0));"
    ...
    ! Solve and print summary ...
    ! NOTE: python3.10 -c "import pyguymer3; print(pyguymer3.calc_loc_from_loc_and_bearing_and_dist(170.0, 10.0, 80.0, 4000000.0));"
    CALL sub_calc_loc_from_loc_and_bearing_and_dist(lon1, lat1, bear1, dist, lon2, lat2, bear2)
    WRITE(fmt = '("How does Python compare to FORTRAN?")', unit = OUTPUT_UNIT)
